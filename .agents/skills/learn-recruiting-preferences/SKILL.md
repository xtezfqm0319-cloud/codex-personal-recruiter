...
description: Capture, propose, confirm, and apply the user's personal recruiting judgment preferences from explicit feedback and recurring decision differences. Use when the user says what they value, rejects Codex's reasoning, asks Codex to remember a hiring preference, or wants analysis of how their decisions differ from prior AI recommendations.
---
